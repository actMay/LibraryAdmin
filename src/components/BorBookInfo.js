...
class BorBookInfoUI extends Component{
  constructor() {
    super();
    this.state={
  ...
  render() {
    return (
      <div>
        ...
        <div className="bookAdminSearch">
          <span className="bookAdminTitle">借书人姓名:</span>
          <div className="bookInput">
            <Input placeholder="请输入借书人姓名" type="text"/>
          </div>
        </div>
...
const BorBookInfo = connect(
  mapStateToProps,
  mapDispatchToProps
)(BorBookInfoUI);

export default BorBookInfo;
